...
public class BBLootModifiers {
    ...
    private static final ResourceLocation AZALEA_LEAVES = ResourceLocation.withDefaultNamespace("blocks/azalea_leaves");
    private static final ResourceLocation FLOWERING_AZALEA_LEAVES = ResourceLocation.withDefaultNamespace("blocks/flowering_azalea_leaves");
    ...
    private static final ResourceLocation BASTION_OTHER = ResourceLocation.withDefaultNamespace("chests/bastion_other");
