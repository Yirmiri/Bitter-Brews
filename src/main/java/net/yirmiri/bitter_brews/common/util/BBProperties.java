package net.yirmiri.bitter_brews.common.util;
...
import net.yirmiri.bitter_brews.common.block.SoulPepperCropBlock;
import net.yirmiri.bitter_brews.common.block.StoveBlock;

public class BBProperties {
    public static class BlockP {
        //MISC
        public static final BlockBehaviour.Properties MUD_STOVE = BlockBehaviour.Properties.ofFullCopy(Blocks.MUD_BRICKS).mapColor(MapColor.TERRACOTTA_RED).lightLevel((state) -> { return StoveBlock.burntOut(state) ? 6 : 15; });
        public static final BlockBehaviour.Properties MUD_COUNTER = BlockBehaviour.Properties.ofFullCopy(Blocks.MUD_BRICKS);
        public static final BlockBehaviour.Properties AZALEA_FLOWER = BlockBehaviour.Properties.ofFullCopy(Blocks.GLOW_LICHEN).lightLevel((state) -> 0).sound(SoundType.WET_GRASS).mapColor(MapColor.TERRACOTTA_PINK);
        public static final BlockBehaviour.Properties PEPPER_CROP = BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_WART).sound(SoundType.ROOTS).mapColor(MapColor.COLOR_RED);
        public static final BlockBehaviour.Properties SOUL_PEPPER_CROP = BlockBehaviour.Properties.ofFullCopy(Blocks.NETHER_WART).sound(SoundType.ROOTS).mapColor(MapColor.COLOR_CYAN).lightLevel((state) -> { return SoulPepperCropBlock.mature(state) ? 0 : 7; });
        public static final BlockBehaviour.Properties COPPER_TEA_KETTLE = BlockBehaviour.Properties.ofFullCopy(Blocks.COPPER_BLOCK).sound(SoundType.LANTERN);
        public static final BlockBehaviour.Properties COFFEE_BUSH = BlockBehaviour.Properties.ofFullCopy(Blocks.WHEAT).sound(SoundType.WET_GRASS).mapColor(MapColor.TERRACOTTA_GREEN);
    }
    ...
    public static class ItemP {
        ...
        public static final Item.Properties DRIED_TEA_LEAVES = new Item.Properties().food(new FoodProperties.Builder().nutrition(1).saturationModifier(0.1F).build());
        public static final Item.Properties MANGO = new Item.Properties().food(new FoodProperties.Builder().nutrition(4).saturationModifier(0.4F).build());
        public static final Item.Properties PEPPER = new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationModifier(0.3F).effect(new MobEffectInstance(MobEffects.FIRE_RESISTANCE, BRIEF_DURATION, 0), 1.0F).alwaysEdible().build());
        public static final Item.Properties SOUL_PEPPER = new Item.Properties().food(new FoodProperties.Builder().nutrition(6).saturationModifier(0.6F).effect(new MobEffectInstance(TLStatusEffects.TRAIL_BLAZING, BRIEF_DURATION, 0), 1.0F).alwaysEdible().build());

        //DRINKS
        public static final Item.Properties WATER = new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().alwaysEdible().build());
        public static final Item.Properties MILK = new Item.Properties().stacksTo(16).food(new FoodProperties.Builder().alwaysEdible().build());
