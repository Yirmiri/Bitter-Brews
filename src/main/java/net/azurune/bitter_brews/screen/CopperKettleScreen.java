...
public class CopperKettleScreen extends AbstractContainerScreen<CopperKettleScreenHandler> {
    ...
    public CopperKettleScreen(CopperKettleScreenHandler menu, Inventory inv, Component title) {
