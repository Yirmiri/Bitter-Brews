...
public class BBEnUsLangGen extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add("advancements.husbandry.consume_all_brews.title", "Taste The Rainbow");
        add("advancements.husbandry.consume_all_brews.description", "Consume all of the brews in Bitter Brews.");
